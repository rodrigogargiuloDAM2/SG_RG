    ...
    public void Buscar(View view){
        ...
        if (!idP.isEmpty()){
            Cursor fila = db.rawQuery
                    ("select id, nombreProducto,descripcion,tienda, marca, categoria,precio, cantidad, id_email from productos where id =" + idP+" and id_email='"+DatoEmail+"'", null);
            ...
            if (fila.moveToFirst()){ //identifica si la consulta contiene valores para mostrarlo
                ...
                txt_precioP.setText(fila.getString(5));
                txt_cantidadP.setText(fila.getString(6));
                txt_cantidadP.setText(fila.getString(6));
